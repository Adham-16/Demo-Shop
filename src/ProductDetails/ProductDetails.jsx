        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
          ...
          <div className="mt-6 sm:mt-8 lg:mt-0">
            ...
            <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
              <a href="#" title className="flex items-center justify-center py-2.5 px-5 text-sm font-medium text-[#434445] focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700   dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" role="button">
